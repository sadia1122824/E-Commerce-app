...
<body>
  ...
  <main class="content-wrapper">
          ...
          <div class="col-md-6 col-lg-5 d-flex flex-column">
            <div class="py-4 mt-auto">
              <div class="swiper pb-1 pt-3 pt-sm-4 py-md-4 py-lg-3" data-swiper="{
                ...
                <!-- //khoteyyy -->
                <div class="swiper-wrapper align-items-center" id='banner_wordings'>
          ...
          <div class="col-md-6 col-lg-7 align-self-end">
            <div class="position-relative ms-md-n4">
              ...
              <div class="swiper position-absolute top-0 start-0 w-100 h-100 user-select-none" id="heroImages" data-swiper="{
                ...
                <div class="swiper-wrapper" id="banner_images">
    ...
    <section class="container pb-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
      ...
      <!-- Products grid -->
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 gy-4 gy-md-5 pb-xxl-3" id="featured_products">
      ...
      <div class="text-center pt-xxl-3 pb-2 pb-md-3">
        <h2 class="pb-2 mb-1">
          <span class="animate-underline">
            <a class="animate-target text-dark-emphasis text-decoration-none" href="#!" id="company_name_here"></a>
          </span>
        </h2>
...
<!-- Mirrored from cartzilla-html.createx.studio/home-fashion-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 05:58:32 GMT -->
<script>
  let get_banners = async () => {
    let banner_wordings = document.getElementById('banner_wordings');
    let banner_images = document.getElementById('banner_images');
    let response = await fetch('./apis/get_banners.php');
    let result = await response.json();

    if (result.status === 'success') {
      result.data.forEach(element => {
        banner_wordings.innerHTML +=
          `
          <div class="swiper-slide text-center text-md-start">
            <p class="fs-xl mb-2 mb-lg-3 mb-xl-4">${element.banner_one_title}</p>
            <h2 class="display-4 text-uppercase mb-4 mb-xl-5">${element.banner_one_description}</h2>
          </div>
          <div class="swiper-slide text-center text-md-start">
            <p class="fs-xl mb-2 mb-lg-3 mb-xl-4">${element.banner_two_title}</p>
            <h2 class="display-4 text-uppercase mb-4 mb-xl-5">${element.banner_two_description}</h2>
          </div>
          <div class="swiper-slide text-center text-md-start">
            <p class="fs-xl mb-2 mb-lg-3 mb-xl-4">${element.banner_three_title}</p>
            <h2 class="display-4 text-uppercase mb-4 mb-xl-5">${element.banner_three_description}</h2>
          </div>
        `;
      });
      result.data.forEach(element => {
        banner_images.innerHTML +=
          `
          <div class="swiper-slide">
            <img src="../destone/${element.banner_one_image}" class="rtl-flip" alt="Image">
          </div>

          <div class="swiper-slide">
            <img src="../destone/${element.banner_two_image}" class="rtl-flip" alt="Image">
          </div>

          <div class="swiper-slide">
            <img src="../destone/${element.banner_three_image}" class="rtl-flip" alt="Image">
          </div>
        `;
      });
    } else {
  ...
  let get_user_id = async () => {
    let company_name_here = document.getElementById('company_name_here');
    ...
    company_name_here.innerHTML = data;
  }
  get_user_id();


  let get_user_product = async () => {
    let featured_products = document.getElementById('featured_products');
    let response = await fetch('./apis/get_products.php');
    let data = await response.json();
        ...
        <div class="col mb-2 mb-sm-3 mb-md-0">
          <div class="animate-underline hover-effect-opacity">
            <div class="position-relative mb-3">
              ...
              <a class="d-flex bg-body-tertiary rounded p-3" href="products.php?id=${element.id}">
                <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                  <img src="../destone/${element.image_paths}" alt="Image">
                </div>
              </a>
            ...
            <div class="nav mb-2">
              <a class="nav-link animate-target min-w-0 text-dark-emphasis p-0" href="products.php?id=${element.id}">
                <span class="text-truncate">${element.product_name}</span>
              </a>
            </div>
            <div class="d-flex align-items-center gap-2 mb-2">
              <div class="text-muted" style="font-size: 0.75rem;">
                <del>${element.compare_price}</del>
              </div>
              <div class="h6 mb-0">${element.original_price}</div>
            </div>
